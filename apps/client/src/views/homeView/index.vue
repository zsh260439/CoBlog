...
const skillGroups: HomeSkillGroup[] = [
  {
    ...
    badge: 'FE',
    title: '前端开发',
    subtitle: 'Vue 3、Vite 与博客前后台页面实现',
    metrics: [
      { label: '核心模块', value: '6+' },
      { label: '页面类型', value: '3' },
      { label: '主要方向', value: 'FE' },
    ...
    details: [
      ...
      { name: 'Markdown 编辑与预览', level: '熟练' },
      { name: 'Element Plus 管理端页面', level: '熟练' },
  ...
  },
  {
    ...
    badge: 'AI',
    title: 'AI 写作',
    subtitle: 'LLM API、SSE 流式输出与内容生产工作台',
    metrics: [
      { label: '写作任务', value: '6' },
      { label: '输出方式', value: 'SSE' },
      { label: '主要场景', value: 'Editor' },
    ],
    details: [
      { name: '标题与摘要生成', level: '熟练' },
      { name: '正文润色与续写', level: '熟练' },
      { name: 'Markdown 结构优化', level: '熟练' },
      { name: '标签分类建议', level: '熟练' },
      { name: 'SSE 断线回放', level: '熟练' },
      { name: 'LLM 接口封装', level: '熟练' },
    ],
  },
  {
    id: 'backend',
    badge: 'BE',
    title: '后端开发',
    subtitle: 'NestJS、MongoDB、Redis 与博客后台接口能力',
    metrics: [
      { label: '接口模块', value: '6+' },
      { label: '数据能力', value: 'MongoDB' },
      { label: '安全能力', value: 'Redis' },
    ],
    details: [
      { name: 'NestJS 模块化接口', level: '熟练' },
      { name: 'MongoDB Schema 设计', level: '熟练' },
      { name: 'Redis ZSet 限流', level: '熟练' },
      { name: 'JWT 管理员鉴权', level: '熟练' },
      { name: 'HttpOnly 访客身份', level: '熟练' },
      { name: '图片上传安全校验', level: '熟练' },
    ],
  },
]
...
const projects: HomeProjectItem[] = [
  {
    id: 'coblog',
    title: 'CoBlog AI 辅助博客系统',
    summary: '围绕文章编辑、AI 写作、留言实时同步、访问统计和后台运营搭建的个人博客系统，重点强化内容生产效率、接口安全和实时交互体验。',
    year: '2026',
    tags: ['Vue 3', 'TypeScript', 'NestJS', 'Redis', 'SSE', 'LLM'],
    href: '/blog',
    internal: true,
  },
  {
    id: 'koreai',
    title: 'KoreAI 多模态 RAG 问答系统',
    summary: '面向个人知识管理场景的多模态 RAG 问答系统，支持多格式文档解析、混合检索、流式回答、引用溯源和运行链路复盘。',
    year: '2026',
    tags: ['Vue 3', 'NestJS', 'PostgreSQL', 'BM25', 'pgvector', 'LangChain'],
